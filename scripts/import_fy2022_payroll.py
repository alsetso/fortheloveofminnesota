...
FILE_PATH = ROOT / "minnesota_gov" / "State Payrole" / "fiscal-year-2022.xlsx"
...
def main():
    ...
    # Resolve sheet names (FY22 HR INFO, FY22 EARNINGS in this file)
    ...
    # FY-specific active column (e.g. ACTIVE_ON_JUNE_30_2022)
