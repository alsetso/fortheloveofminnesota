...
export default function ProfileTopbar({ profileUsername, isSidebarOpen = true, onSidebarToggle }: ProfileTopbarProps) {
  ...
  // Left section with sidebar toggle before Home icon
  const leftSection = (
    <div className="hidden md:flex items-center gap-0 min-w-0 justify-start h-full">
      {/* Sidebar Toggle - Icon only, left of Home */}
      {onSidebarToggle && (
        <button
          onClick={onSidebarToggle}
          className="flex items-center justify-center px-2 h-full min-w-[44px] transition-colors text-gray-600 hover:text-gray-900 flex-shrink-0"
