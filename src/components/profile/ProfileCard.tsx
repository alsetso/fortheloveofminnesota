          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              {!isEditingTraits && (
                <Link
                  href="/settings"
                  className={`inline-flex items-center justify-center p-1.5 rounded-md shrink-0 grow-0 basis-auto leading-none transition-colors ${
                    darkMode ? 'text-white/60 hover:text-white hover:bg-white/10' : 'text-gray-500 hover:text-gray-900 hover:bg-gray-100'
                  }`}
                  aria-label="Settings"
                >
