...
import SkipTracingMapClient from './SkipTracingMapClient';
...
export default async function SkipTracingMapPage() {
  ...
  return (
    <SkipTracingMapClient cities={cities} counties={counties} />
  );
}
