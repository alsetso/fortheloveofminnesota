...
const FlightMap = lazy(() => import('@/components/transportation/FlightMap'));
    ...
    >
      <div className="flex flex-col h-full p-4 space-y-3">
        <div className="space-y-1 flex-shrink-0">
          <h1 className="text-sm font-semibold text-gray-900 dark:text-foreground">Flight Tracker</h1>
          <p className="text-xs text-gray-500 dark:text-foreground-muted">
            Live flight tracking over Minnesota airspace
          </p>
        </div>
