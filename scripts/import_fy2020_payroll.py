...
FILE_PATH = ROOT / "minnesota_gov" / "State Payrole" / "fiscal-year-2020.xlsx"
...
def main():
    ...
    # Resolve sheet names (FY20 HR INFO, FY20 EARNINGS in this file)
    ...
    # FY-specific active column (e.g. ACTIVE_ON_JUNE_30_2020)
