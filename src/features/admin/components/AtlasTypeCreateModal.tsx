...
interface AtlasTypeCreateModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: () => void;
}

export default function AtlasTypeCreateModal({
  isOpen,
  onClose,
  onSave,
}: AtlasTypeCreateModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(error instanceof Error ? error.message : 'Failed to create atlas type');
    } finally {
      setSaving(false);
    }
  };
      ...
      <div className="fixed inset-0 z-[101] flex items-center justify-center pointer-events-none p-4">
        ...
        >
          ...
          <div className="sticky top-0 bg-white border-b border-gray-200 px-[10px] py-3 flex items-center justify-between">
            <h2 className="text-sm font-semibold text-gray-900">Create Atlas Type</h2>
            <button
              onClick={handleClose}
              disabled={saving}
