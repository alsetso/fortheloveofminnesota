...
interface JoinMapSidebarProps {
  mapId: string;
  mapName: string;
  mapData?: MapData | null; // Map data for URL normalization
...
export default function JoinMapSidebar({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (data.auto_approved) {
        ...
        // Show success toast
        toast.success(`${username} just joined ${mapName}`, {
          duration: 4000,
        });
        ...
        // Hard refresh to ensure membership state is updated and UI reflects member status
        // This forces a full page reload which will:
        // 1. Re-fetch map data including updated members list
        // 2. Update useMapMembership hook with new membership status
        // 3. Show correct UI (member buttons, settings access, etc.)
        // Fallback: hard refresh current page
  ...
  const handleRevokeRequest = async () => {
    ...
    try {
      ...
      setHasPendingRequest(false);
      setPendingRequestId(null);
      toast.success('Membership request revoked', {
        duration: 3000,
      });
    } catch (err: any) {
      ...
      <div className="flex-1 overflow-y-auto px-2 py-2 scrollbar-hide bg-gray-50">
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <h2 className="text-sm font-semibold text-gray-900">{mapName}</h2>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="bg-white border border-gray-200 rounded-md p-[10px]">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {allowAreas && (
                        <div className="flex items-center gap-1.5 px-2 py-1 bg-gray-50 rounded-md border border-gray-200">
                          <Square3Stack3DIcon className="w-3.5 h-3.5 text-gray-600 flex-shrink-0" />
