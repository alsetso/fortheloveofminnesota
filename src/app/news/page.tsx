...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'News | For the Love of Minnesota',
    description: 'Stay updated with the latest Minnesota news, breaking stories, local updates, and community events.',
    url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://fortheloveofminnesota.com'}/news`,
  ...
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://fortheloveofminnesota.com'}/news`,
  },
};
