...
/**
 * POST /api/admin/mention-icons/upload-icon
 * Upload mention icon
 * 
 * Security:
      ...
      try {
        ...
        if (error) {
          if (process.env.NODE_ENV === 'development') {
            console.error('[Mention Icons Upload] Error uploading file:', error);
          }
        ...
        if (process.env.NODE_ENV === 'development') {
          console.error('[Mention Icons Upload] Error:', error);
        }
