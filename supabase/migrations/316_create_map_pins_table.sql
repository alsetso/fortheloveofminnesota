...
-- Simple pins that connect to maps with emoji, caption, image_url, video_url
...
CREATE INDEX idx_map_pins_map_id ON public.map_pins(map_id);
...
COMMENT ON TABLE public.map_pins IS 'Pins on maps with emoji, caption, image_url, and video_url';
