...
export default function MapControls({ map, mapLoaded, is3DMode = false, on3DToggle }: MapControlsProps) {
  ...
  return (
    <div 
      className="fixed bottom-[10px] right-[10px] z-30 flex flex-col gap-2 bg-white border border-gray-200 rounded-md p-[10px]"
    >
