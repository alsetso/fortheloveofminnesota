...
COMMENT ON COLUMN public.accounts.traits IS
  'Array of account traits that help define the account''s activities. Users can select multiple traits from: homeowner, buyer, investor, realtor, wholesaler, lender, title.';
