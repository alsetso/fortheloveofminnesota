...
import { ArrowLeftIcon, XMarkIcon, CheckIcon, ChevronDownIcon } from '@heroicons/react/24/outline';
...
export default function EditPostPage() {
  ...
  useEffect(() => {
    ...
    const loadPost = async () => {
      ...
      try {
        ...
        setSelectedGroupId(postData.group_id || null);
        ...
        console.error('[EditPostPage] Error loading post:', err);
        setError('Failed to load post');
      } finally {
        setLoading(false);
      }
  ...
  useEffect(() => {
    ...
    const fetchGroups = async () => {
      ...
      try {
        ...
        console.error('[EditPostPage] Error fetching groups:', err);
      } finally {
  ...
  useEffect(() => {
    const fetchMentionTypes = async () => {
      ...
      try {
        ...
        console.error('[EditPostPage] Error fetching mention types:', err);
      } finally {
  ...
  useEffect(() => {
    ...
    const fetchMentions = async () => {
      ...
      try {
        ...
        console.error('[EditPostPage] Error fetching mentions:', err);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('[EditPostPage] Error updating post:', err);
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href={`/post/${postId}`} className="text-blue-600 hover:text-blue-700">
            Back to post
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b border-gray-200 bg-white sticky top-0 z-10">
        <div className="max-w-[600px] mx-auto px-4 py-3 flex items-center justify-between">
          <Link href={`/post/${postId}`} className="flex items-center gap-2 text-gray-600 hover:text-gray-900">
